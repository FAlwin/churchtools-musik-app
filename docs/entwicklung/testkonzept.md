...
zusätzlich manuell (bzw. auf Staging) geprüft. Stand nach #145: **98 Testdateien** –
**65 Client (550 Tests)** + **33 Server (347 Tests)** mit Vitest + **5 Playwright-E2E** (Render-Smoke + voller Auth-Flow).
