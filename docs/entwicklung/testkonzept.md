...
zusätzlich manuell (bzw. auf Staging) geprüft. Stand nach #306: **85 Testdateien** –
**55 Client (431 Tests)** + **30 Server (311 Tests)** mit Vitest + **5 Playwright-E2E** (Render-Smoke + voller Auth-Flow).
