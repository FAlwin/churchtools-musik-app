...
/**
 * Lied-Auswahl beim Hinzufügen/Verknüpfen – **der Ort des Quellen-Umschalters** (#378, #381).
 *
 ...
 *
 * **Ein Antippen führt in die Vorschau, nicht direkt zum Einfügen** (#381, Muster ProPresenter): Der
          ...
          f.list.map((s: SongLibraryEntry) => {
            ...
            return (
              <div key={s.songId} className={styles.zeile}>
                {/* Antippen führt in die Vorschau (#381) … */}
                <button
